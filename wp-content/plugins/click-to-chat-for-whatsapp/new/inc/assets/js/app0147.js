!(function (t) {
  t(function () {
    ...
    if ("no" == n)
      n = void 0 !== screen.width && screen.width > 1025 ? "no" : "yes";
    var a = "",
      _ = {};
    function o() {
    ...
    function y(_) {
      ...
      var o = s.number,
        i = s.pre_filled;
      _.hasAttribute("data-number") &&
        "" !== _.getAttribute("data-number") &&
        (o = _.getAttribute("data-number")),
        _.hasAttribute("data-pre_filled") &&
          (i = _.getAttribute("data-pre_filled"));
      try {
        i = i.replaceAll("%", "%25");
      ...
      if ("" != o) {
        ...
        "yes" == n
          ? (s.url_structure_m &&
              ((h = "whatsapp://send?phone=" + o + "&text=" + i),
              (d = "_self")),
            s.custom_url_m && "" !== s.custom_url_m && (h = s.custom_url_m))
          : (s.url_structure_d &&
              (h = "https://web.whatsapp.com/send?phone=" + o + "&text=" + i),
            s.custom_url_d && "" !== s.custom_url_d && (h = s.custom_url_d));
        var l =
          "popup" == d
        ...
        window.open(h, d, l),
            ...
            function t(t) {
              ...
              try {
                document.dispatchEvent(
                  ...
                  (t = (t = (t = (t =
                    void 0 !== window.apply_variables_value
                      ? window.apply_variables_value
                      : t).replace("{number}", n)).replace(
                    "{title}",
                    c
                  )).replace("{url}", e));
              } catch (t) {}
            ...
            if (s.ga) {
              ...
              0 == h &&
                ...
                ("undefined" != typeof gtag
                  ...
                  ? ga.getAll()[0].send("event", _, o, i)
                  : "undefined" != typeof __gaTracker &&
                    __gaTracker("send", "event", _, o, i));
            }
            if (
              ...
              var m =
                ...
                v =
                  u.pixel_event_type && "" !== u.pixel_event_type
                    ? u.pixel_event_type
                    : "trackCustom",
                f = {};
              u.pixel_params &&
                u.pixel_params.forEach((e) => {
                  if (u[e]) {
                    var c = u[e],
                      n = c.key,
                      a = c.value;
          ...
          (function (e) {
            if (s.hook_url) {
              ...
              var _ = s.hook_url;
              if (
                ((c = s.hook_v), s.webhook_format && "json" == s.webhook_format)
              )
                var o = c;
